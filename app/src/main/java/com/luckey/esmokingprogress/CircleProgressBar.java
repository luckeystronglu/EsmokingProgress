...
public class CircleProgressBar extends View {
    ...
    protected void drawBackground(Canvas canvas) {
        ...
        float cx = -mRadius+ halfSize;
        canvas.save();
//        canvas.drawCircle(0,cx,circleRadius,circlepaint);
//        canvas.drawCircle(0,-cx,circleRadius,circlepaint);
//        canvas.drawCircle(cx,0,circleRadius,circlepaint);
//        canvas.drawCircle(-cx,0,circleRadius,circlepaint);
//        canvas.drawCircle((float) Math.sin(Math.PI*135/180)*cx,(float) Math.cos(Math.PI*135/180)*cx,circleRadius,circlepaint);
//        canvas.drawCircle((float) Math.sin(Math.PI*135/180)*-cx,(float) Math.cos(Math.PI*135/180)*cx,circleRadius,circlepaint);
//        canvas.drawCircle((float) Math.sin(Math.PI*135/180)*cx,(float) Math.cos(Math.PI*135/180)*-cx,circleRadius,circlepaint);
//        canvas.drawCircle((float) Math.sin(Math.PI*135/180)*-cx,(float) Math.cos(Math.PI*135/180)*-cx,circleRadius,circlepaint);
        canvas.drawCircle(0,cx,circleRadius,circlepaint);
        canvas.drawCircle((float) Math.sin(Math.PI*36/180)*cx,(float) Math.cos(Math.PI*36/180)*cx,circleRadius,circlepaint);
        canvas.drawCircle((float) Math.sin(Math.PI*72/180)*cx,(float) Math.cos(Math.PI*72/180)*cx,circleRadius,circlepaint);
        canvas.drawCircle((float) Math.sin(Math.PI*108/180)*cx,(float) Math.cos(Math.PI*108/180)*cx,circleRadius,circlepaint);
        canvas.drawCircle((float) Math.sin(Math.PI*144/180)*cx,(float) Math.cos(Math.PI*144/180)*cx,circleRadius,circlepaint);
        canvas.drawCircle((float) Math.sin(Math.PI*180/180)*cx,(float) Math.cos(Math.PI*180/180)*cx,circleRadius,circlepaint);
        canvas.drawCircle((float) Math.sin(Math.PI*36/180)*-cx,(float) Math.cos(Math.PI*36/180)*cx,circleRadius,circlepaint);
        canvas.drawCircle((float) Math.sin(Math.PI*72/180)*-cx,(float) Math.cos(Math.PI*72/180)*cx,circleRadius,circlepaint);
        canvas.drawCircle((float) Math.sin(Math.PI*108/180)*-cx,(float) Math.cos(Math.PI*108/180)*cx,circleRadius,circlepaint);
        canvas.drawCircle((float) Math.sin(Math.PI*144/180)*-cx,(float) Math.cos(Math.PI*144/180)*cx,circleRadius,circlepaint);
...
//        canvas.drawCircle((float) Math.sin(Math.PI*135/180)*-cx,(float) Math.cos(Math.PI*135/180)*-cx,circleRadius,circlepaint);
    ...
    protected void drawProgress(Canvas canvas) {
        ...
        cirHeaderpaint.setStrokeWidth(5);
        cirHeaderpaint.setColor(Color.parseColor("#FFF4F8F4"));
